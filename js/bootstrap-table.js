...
!function ($) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        formatNoMatches: function () {
            return 'No se encontró registros coincientes';
        },
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.toolbarContent!=undefined) {
            this.$toolbar = $(document).find(this.options.toolbarContent).html('');
        }
        else {
        ...
        if (this.options.showRefresh) {
            html.push('<button class="' + this.options.toolbarCssBtn + '" type="button" name="refresh">',
                '<i class="glyphicon glyphicon-refresh icon-refresh"></i>',
                '</button>');
        }

        if (this.options.showToggle) {
            html.push('<button class="' + this.options.toolbarCssBtn + '" type="button" name="toggle">',
        ...
        if (this.options.showColumns) {
            html.push(sprintf('<div class="keep-open %s">',
                ...
                '<button type="button" class="' + this.options.toolbarCssBtn + ' dropdown-toggle" data-toggle="dropdown">',
        ...
        if (html.length > 2) {
            this.$toolbar.append(html.join(''));' + this.options.toolbarCssBtn + '
        }
        ...
        if (this.options.search) {
            ...
            html.push(
                '<div class="pull-right search">',
                    sprintf('<input class="form-control ' + this.options.searchCssBtn + '"  type="text" placeholder="%s">',
    ...
    BootstrapTable.prototype.updateDataRow = function (data) {
        //alert(data);
        //this.initData(data, true);
        //this.initBody();
    };
